...
/* harmony import */ var _lib_post__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7675);
...
async function getStaticPaths() {
    const paths = (0,_lib_post__WEBPACK_IMPORTED_MODULE_3__/* .getAllPostIds */ .Le)();
    return {
        paths,
        fallback: false
    };
...
async function getStaticProps({ params  }) {
    const postData = await (0,_lib_post__WEBPACK_IMPORTED_MODULE_3__/* .getPostData */ .AU)(params.id);
    return {
        props: {
            postData
        }
...
var __webpack_exports__ = __webpack_require__.X(0, [730,664,675,476], () => (__webpack_exec__(9955)));
